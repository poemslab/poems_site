          ...
          <div className={styles.alert}>
            <div>
              ...
              <div className={styles.alert_subtitle}>
                люди которые <span className={styles.bold}>пользуются нашим сайтом</span> на <span className={styles.bold}>99%</span> счастливие тех людей, которые наш <span className={styles.bold}>сайт не используют!</span>
              </div>
            </div>
          </div>
